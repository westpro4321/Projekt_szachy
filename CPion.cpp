...
#include "CFigury.h"
    ...
    CPion::CPion(char kolorek) : CFigury(kolorek) {}  //konstruktor nadający kolor
    ...
    bool CPion::Ruch(int PWiersz, int PKolumna, int KWiersz, int KKolumna, CFigury * Tabliczka[8][8]) {   // ruch (współrzędne początka i końca ruchu oraz wskaźnik do planszy)czy ruch moze zostac wykonany
        CFigury* Cel = Tabliczka[KWiersz][KKolumna];                  // wskaźnik do współrzędnych końca ruchu
